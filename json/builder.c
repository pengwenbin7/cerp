...
int main(int argc, char *argv[])
{
  ...
  json_builder_begin_object(builder);
  json_builder_set_member_name(builder, "cn");
  json_builder_add_string_value(builder, "中国");
  json_builder_set_member_name(builder, "us");
  json_builder_add_string_value(builder, "美国");
